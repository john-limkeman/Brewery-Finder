...
VALUES ('Great Divide Brewing Co', '2201 Arapahoe St, Denver, CO 80205', 'Intimate, lively joint offering tastes of their own brews, growlers to go & food truck options.', 'https://www.coloradobrewerylist.com/wp-content/uploads/2014/02/great-divide.jpg', 'https://greatdivide.com/', 3032969460, '3 PM - 9PM', true);
INSERT INTO breweries (name, address, description, image, brewery_url, phone, hours, active) 
...
INSERT INTO events (brewery_id, event_title, event_date, description, picture) VALUES (2, 'Broncos vs Eagles', '10/18/2020', 'Come enjoy a pint with friends while the game is on', 'https://s.secure.espncdn.com/stitcher/sports/football/nfl/events/400951760.png?templateId=espn.com.share.1');
